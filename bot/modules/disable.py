...
from bot.modules.helper_funcs.handlers import CMD_STARTERS, CustomCommandHandler
...
if is_module_loaded(FILENAME):
    ...
    from bot.modules.helper_funcs.chat_status import user_admin, is_user_admin, connection_status
    from bot.modules.sql import disable_sql as sql
    ...
    def disable_module(bot: Bot, update: Update, args: List[str]):
        chat = update.effective_chat
        if len(args) >= 1:
            disable_module = "bot.modules." + args[0].rsplit(".", 1)[0]
